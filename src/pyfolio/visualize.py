...
def plot_montecarlo_simulation(optimal_weights, optimal_portfolio, simulated_portfolios, pfolio_assets, returnP, riskP, sharpeP,out_path=None, figsize=(10, 8)):
    ...
    plt.scatter(riskP, returnP, color='red', marker='o', s=100)  # Mark the Portfolio performance
    plt.scatter(optimal_portfolio['Risk'], optimal_portfolio['Return'], color='green', marker='*', s=100)  # Mark the optimal portfolio
